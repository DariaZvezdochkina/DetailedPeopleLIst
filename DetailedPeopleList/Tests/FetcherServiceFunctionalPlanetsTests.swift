...
class FetcherServiceFunctionalPlanetsTests: XCTestCase {
    ...
    func testCorrectURLShouldReturnTypePlanets() async {
        ...
        do {
            ...
            XCTAssertNotNil(planets, "Planets object should not be nil")
            XCTAssertEqual(planets, examplePlanets, "Both Data Type should conform Type Planets")
        } catch {
...
"""
        let planetsData = examplePlanets.data(using: .utf8)!
        return planetsData
    }
}
